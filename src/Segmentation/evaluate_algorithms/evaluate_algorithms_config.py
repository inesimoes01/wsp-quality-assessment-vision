...
# MRCNN MODELS
DROPLET_MRCNN_MODEL = "models\\droplets\\mrcnn\\logs_2\\droplet_dataset20240906T1631\\mask_rcnn_droplet_dataset_0100.h5"

#DROPLET_CELLPOSE_MODEL = 
...
EVAL_DROPLET_SEGM_REAL_DATASET_CELLPOSE = os.path.join(EVAL_MAIN_DROPLET_REAL_PATH, "droplet_real_segmentation_cellpose.csv")
EVAL_DROPLET_STATS_REAL_DATASET_CELLPOSE = os.path.join(EVAL_MAIN_DROPLET_REAL_PATH, "droplet_real_statistics_cellpose.csv")
...
EVAL_DROPLET_SEGM_REAL_FULL_DATASET_CELLPOSE = os.path.join(EVAL_MAIN_DROPLET_REAL_PATH, "droplet_real_full_segmentation_cellpose.csv")
EVAL_DROPLET_STATS_REAL_FULL_DATASET_CELLPOSE = os.path.join(EVAL_MAIN_DROPLET_REAL_PATH, "droplet_real_full_statistics_cellpose.csv")
...
EVAL_DROPLET_SEGM_SYNTHETIC_DATASET_CELLPOSE = os.path.join(EVAL_MAIN_DROPLET_SYNTHETIC_PATH, "droplet_synthetic_segmentation_cellpose.csv")
EVAL_DROPLET_STATS_SYNTHETIC_DATASET_CELLPOSE = os.path.join(EVAL_MAIN_DROPLET_SYNTHETIC_PATH, "droplet_synthetic_statistics_cellpose.csv")
...
EVAL_DROPLET_SEGM_SYNTHETIC_FULL_DATASET_CELLPOSE = os.path.join(EVAL_MAIN_DROPLET_SYNTHETIC_PATH, "droplet_synthetic_full_segmentation_cellpose.csv")
EVAL_DROPLET_STATS_SYNTHETIC_FULL_DATASET_CELLPOSE = os.path.join(EVAL_MAIN_DROPLET_SYNTHETIC_PATH, "droplet_synthetic_full_statistics_cellpose.csv")
