...
def compute_yolo_segmentation_full(image_path, yolo_model, x_offset, y_offset):
    predicted_droplets_adjusted = []
    ...
    if results[0].masks:
        ...
        for i, polygon in enumerate(predicted_droplets_adjusted):
            ...
            predicted_droplets_adjusted_with_edges.append((polygon, i, isEdge))              
            
    return predicted_droplets_adjusted_with_edges
...
def main_yolo_squares(fieldnames_segmentation, fieldnames_statistics, fieldnames_time, path_csv_segmentation, path_csv_statistics, path_dataset, path_results, yolo_model_path):
    ...
    with open(segmentation_time_csv_path, mode='w', newline='') as csvfile:
        ...
        for i, file in enumerate(os.listdir(directory_image)): 
            ...
            try:
                predicted_droplets = compute_yolo_segmentation_simple_normal(image_path, yolo_model)
        ...
        for i, file in enumerate(os.listdir(directory_image)): 
            ...
            try:
                ...
                for (square, x_offset, y_offset, (x, y, _)) in squares:
                    ...
                    predicted_droplets = compute_yolo_segmentation_full(image_path, yolo_model, x_offset, y_offset)
                ...
                handle_edge_cases(label_path, total_predicted_droplets, width, height, 10)
