...
########## loss graphs were created with tensorboard
...
precision_recall_csv = "results\\model_graphs\\mrcnn\\precision_recall.csv"
...
df.to_csv(precision_recall_csv, index=False)
